                       ...
                       _.each(
                           event.response.rows,
                            function(row) {
                                    ...
                                    tablerows.push("<tr><td><button class='mapit' value='"+row.scientificname+"'>map</button>&nbsp;<a class='getimages' data-scientificname='"+row.scientificname+"'></a></td>" +
                                        "<td class='wiki'>" +
                        ...
                        $(".tablesorter", $(infoWindow.content)
                         ...
                         _.each(
                             $('.getimages',$(infoWindow.content)),
                           function(a) {
                                 $(a).click(
                                     function(event) {
                                        self.bus.fireEvent(new mol.bus.Event('get-images',{names:$(button).val()}));
                                    }
                                 );
                            }
                            );
                         ...
                         $.post(
                            'eol/images',
                            {
                                names : _.keys(scientificnames).join(',')
                            },
                            function(response) {
                               $(self.display).empty();
                               _.each(
