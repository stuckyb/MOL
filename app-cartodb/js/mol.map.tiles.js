    ...
    mol.map.tiles.TileEngine = mol.mvp.Engine.extend(
        {
            ...
            addEventHandlers: function() {
                ...
                /**
                 * The event.layers is an array of objects {name:, type:}.
                 */
                this.bus.addHandler(
                    'add-layers',
                    function(event) {
            ...
            renderTiles: function(layers) {
                ...
                _.each(
                    layers,
                    function(layer) {
                        overlays.push(this.getTileImageMapType(layer.name.trim()));
                    },
                    this
                );
             ...
             */
            getTileImageMapType: function(name) {
                var tile = new mol.map.tiles.PointDensityTile(name);
    ...
    mol.map.tiles.PointDensityTile = Class.extend(
        {
            ...
            createCalls: function(seed) {
                ...
                this.style = "%23eafr { marker-fill:%23E25B5B; marker-opacity:0.9; marker-width:3; marker-line-color:white; marker-line-width:1; marker-line-opacity:0.8; marker-placement:point;	marker-type:ellipse; marker-allow-overlap:true; } ";
